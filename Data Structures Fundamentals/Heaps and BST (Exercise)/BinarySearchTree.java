...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    public BinarySearchTree(Node<E> root) {
        this.root = new Node<>(root.value, root.leftChild, root.rightChild, root.count);
    }
    ...
    public static class Node<E> {
        ...
        public Node(E value, Node<E> leftChild, Node<E> rightChild, int count) {
            this.value = value;
    ...
    public BinarySearchTree<E> search(E element) {
        ...
        while (current != null) {
            ...
            } else if(areEquals(element, current)) {
    ...
    private boolean areEquals(E element, Node<E> node) {
